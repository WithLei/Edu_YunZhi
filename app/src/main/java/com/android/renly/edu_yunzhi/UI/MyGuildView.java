...
import com.android.renly.edu_yunzhi.Utils.ScalePageTransformer;
...
public class MyGuildView extends RelativeLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init(Context context) {
        ...
        dotMargine = UIUtils.dp2px(2);
        containerPaddingTB = UIUtils.dp2px( 8);
        containerPaddingLR = UIUtils.dp2px(12);
